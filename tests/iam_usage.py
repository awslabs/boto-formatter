...
@boto_response_formatter(service_name="iam", function_name="list_access_keys", format_type="csv", output_to="print",pagination="yes")
...
@boto_response_formatter(service_name="iam", function_name="list_roles", format_type="csv", output_to="file" ,pagination="yes")
def list_roles_fmt():
    client = boto3.client('iam')
...
@boto_response_formatter(service_name="iam", function_name="list_users", format_type="csv", output_to="file" ,pagination="yes")
def list_users_fmt():
    client = boto3.client('iam')
