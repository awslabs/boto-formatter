...
@boto_response_formatter(service_name="eks", function_name="describe_cluster", format_type="csv", output_to="file" )
...
@boto_response_formatter(service_name="eks", function_name="list_clusters", format_type="csv", output_to="file" ,pagination="True")
...
@boto_response_formatter(service_name="eks", function_name="list_fargate_profiles", format_type="csv", output_to="file" ,pagination="True")
