...
@boto_response_formatter(service_name="route53", function_name="list_hosted_zones", format_type="csv", output_to="file",pagination="yes")
...
@boto_response_formatter(service_name="route53", function_name="list_hosted_zones_by_vpc", format_type="csv", output_to="file")
...
@boto_response_formatter(service_name="route53", function_name="list_cidr_blocks", format_type="csv", output_to="file",pagination="yes")
